...
public class MajorPearl : Jewel
{
    public override LocalizedText ExaminationLocalization => Language.GetText("Mods.PeculiarJewelry.UI.Exam.Help.MajorPearl");
    protected override Type InfoType => typeof(MajorPearlInfo);
