...
namespace PeculiarJewelry.Content.Items.Jewels.Rares.Moonstone;

public class MajorMoonstone : Jewel
{
    public override LocalizedText ExaminationLocalization => Language.GetText("Mods.PeculiarJewelry.UI.Exam.Help.MajorMoonstone");
    protected override Type InfoType => typeof(MajorMoonstoneInfo);
