...
internal class MinorCatEyeInfo : JewelInfo
{
    ...
    {
        SubStats = [];
        MaterialBonus = Main.rand.Next([.. ModContent.GetContent<BaseMaterialBonus>()]).MaterialKey;
    }
    ...
    {
        tooltips.Add(new TooltipLine(modItem.Mod, "CatMaterialBonus", $"Grants 50% of a {MaterialBonus} bonus."));
        return false;
    }
}
